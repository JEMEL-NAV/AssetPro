table 70182326 "JML AP Pstd Ret Rcpt Ast Ln"
{
    Caption = 'Posted Return Receipt Asset Line';
    DataClassification = CustomerContent;
    LookupPageId = "JML AP Pstd Ret Rcpt Ast Sub";
    DrillDownPageId = "JML AP Pstd Ret Rcpt Ast Sub";
    ...
    fields
    {
        ...
        {
            Caption = 'Document No.';
            ToolTip = 'Specifies the number of the posted return receipt.';
            DataClassification = CustomerContent;
            TableRelation = "Return Receipt Header"."No.";
        }
